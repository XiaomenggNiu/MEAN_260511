...
describe('Day4Component', () => {
  ...
  beforeEach(async () => {
    ...
    mockService.getTodos.and.returnValue(of([{ title: 'hello', body: 'world', id: 0, userId: 1 }]));
    
    await TestBed.configureTestingModule({
      imports: [Day4Component],
      // replace the real service with our mock instance
  ...
  it('should call service and set the todos signal on Init', ()=>{
    // trigger the change detection to invoke the ngOnInit()
